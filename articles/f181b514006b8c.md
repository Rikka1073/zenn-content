...
IAM ユーザーのアクセスキーとシークレットアクセスキーを作成します。

1. 作成した IAM ユーザをクリックします
